...
const LotteryGame = () => {
    ...
    const generateRandomIds = () => {
        if (lifeCount === 0 || rolling || win) return // <-- Disable lever if won
                ...
                if (slotIndex === 2) {
                    setTimeout(() => {
                        if (results[0] === results[1] && results[1] === results[2]) {
                            setGameMsg("🏆 You won a prize! 🎉 Restart to play again.")
                            setWin(true) // trigger confetti
                        } else {
    ...
    return (
        <div className="bg-gradient-to-br from-purple-900 via-slate-900 to-black min-h-screen flex flex-col items-center justify-center">
            {win && <Confetti width={width} height={height} numberOfPieces={200} recycle={false} />}
            ...
            <div className="bg-gradient-to-b from-slate-800 to-slate-900 p-8 rounded-2xl shadow-[0_0_30px_rgba(255,215,0,1)] flex flex-col items-center gap-6 w-[340px] mt-20">
                ...
                <button
                    ...
                    disabled={rolling || win} // <-- Disable after win
